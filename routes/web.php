...
Route::get('mostrarTotalE/{fecha}', ['uses' => 'EntradaController@mostrarTotal']);
...
Route::get('getPedidos/{fecha}', ['uses' => 'PedidoController@getPedidos']);
...
Route::get('ventasTotales/{fecha}', ['uses' => 'VentaController@ventasTotales']);
